...
from utils.architecture.finite_state_machine import FiniteStateMachine
from utils.architecture.sink import ReturnValuesSink
...
if __name__ == '__main__':
    ...
    from utils.architecture.integrity_guard import FilesystemIntegrityGuard
