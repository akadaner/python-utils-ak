from utils.kafka.kafka_adapter import KafkaAdapter
...
if __name__ == "__main__":
    from utils.log import configure_stream_logging
    configure_stream_logging(level=logging.DEBUG)

    from utils.granular_storage.storage import JsonGranularStorage
    from utils.state.provider import PickleDBStateProvider
    from utils.serialization.serializer import JsonSerializer
