from utils_ak.data.table.timeseries.fs import FsTimeSeriesTable
...
class BasicFsTimeSeriesTable(FsTimeSeriesTable):
    ...
    def store_many(self, values, safe=False, overwrite=False):
        ...
        :param safe: will make copy first, write to copy and then rename to initial file. Useful when we don't want data to be crashed at any cost.
        :return:
        """
